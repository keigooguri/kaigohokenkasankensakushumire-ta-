...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const kasanUnits = {
        ...
        'tokuyo_shoki_kasan': "30単位/日",
        'tokuyo_nichijo_keizoku_shien_kasan': "46単位/日",
        'tokuyo_jun_unit_care_kasan': "施設による",
        'tokuyo_jakunen_ninchisho_ukeire_kasan': "120単位/日",
        'tokuyo_shogaisha_seikatsu_shien_taisei_kasan': "26単位/日",
        'tokuyo_mitori_kaigo_kasan': "看取りの段階により変動",
        'tokuyo_yakkin_shokuin_haichi_kasan': "配置状況により変動",
        'tokuyo_zaikaku_fukki_shien_kasan': "実績により変動",
        'tokuyo_kyoryoku_iryo_kikan_renkei_kasan': "100単位/月",
        'tokuyo_tokubetsu_tsuin_soe_kasan': "施設による",
        'tokuyo_taisho_ji_joho_teikyo_kasan': "状況により変動",
        'tokuyo_eiyo_koku_kanri_kasan': "状況により変動",
        'tokuyo_ninchisho_team_care_kasan': "150単位/月",
        'tokuyo_shinko_kansensho_shisetsu_ryoyo_hi': "状況により変動",
        'tokuyo_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'tokuyo_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'tokuyo_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'rouken_jiritsu_shien_sokushin_kasan': "300単位/月",
        'rouken_zaikaku_fukki_shien_kasan': "実績により変動",
        'rouken_rehab_management_kasan': "計画内容により変動",
        'rouken_tanki_shuchu_rehab_kasan': "240単位/日",
        'rouken_ninchisho_tanki_shuchu_rehab_kasan': "240単位/日",
        'rouken_kakaritsukei_renkei_yakuzaichosei_kasan': "100単位/回",
        'rouken_eiyo_koku_kanri_kasan': "状況により変動",
        'rouken_haisetsu_jokusou_management_kasan': "10単位/月",
        'rouken_kyoryoku_iryo_kikan_renkei_kasan': "100単位/月",
        'rouken_mitori_kaigo_kasan': "看取りの段階により変動",
        'rouken_taisho_ji_joho_teikyo_kasan': "状況により変動",
        'rouken_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'rouken_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'rouken_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'iryouin_shoki_kasan': "30単位/日",
        'iryouin_service_taisei_kyoka_kasan': "実績・体制により変動",
        'iryouin_yakan_kinmu_kango_haichi_kasan': "配置状況により変動",
        'iryouin_kyoryoku_iryo_kikan_renkei_kasan': "100単位/月",
        'iryouin_taisho_ji_joho_teikyo_kasan': "状況により変動",
        'iryouin_jiritsu_shien_sokushin_kasan': "300単位/月",
        'iryouin_ninchisho_team_care_suishin_kasan': "150単位/月",
        'iryouin_ryoyoshoku_keiko_iko_iji_kasan': "状況により変動",
        'iryouin_eiyo_koku_kanri_kasan': "状況により変動",
        'iryouin_gaihaku_hiyo_taka_jushin_hiyo_anzen_taisei_kasan': "状況により変動",
        'iryouin_shinko_kansensho_shisetsu_ryoyo_hi': "状況により変動",
        'iryouin_koreisha_shisetsu_kansentaisaku_kojo_kasan': "状況により変動",
        'iryouin_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'iryouin_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'ryoyogata_ryoyo_kino_kyoka_kasan': "施設基準により変動",
        'ryoyogata_judo_ryoyo_kanri_kasan': "状況により変動",
        'ryoyogata_yakan_kango_haichi_kasan': "配置状況により変動",
        'ryoyogata_service_taisei_kyoka_anzen_taisei_kasan': "実績・体制により変動",
        'ryoyogata_eiyo_koku_keiko_iji_kasan': "状況により変動",
        'ryoyogata_ryoyoshoku_kasan': "18単位/日",
        'ryoyogata_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'ryoyogata_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        ...
        'day_service_nyuyoku_kaijo_kasan': "40単位/日(I), 55単位/日(II)",
        'day_service_encho_kasan': "延長時間により変動",
        'day_service_chujudo_care_taisei_kasan': "45単位/日",
        'day_service_seikatsu_sodanin_haichi_kasan': "12単位/日",
        'day_service_ninchisho_kasan_jakunen_ukeire_kasan': "60単位/日(認知症), 120単位/日(若年性)",
        'day_service_seikatsu_kino_kojo_renkei_kasan': "100単位/月(I), 200単位/月(II)",
        'day_service_adl_iji_kasan': "30単位/月(I), 60単位/月(II)",
        'day_service_eiyo_assessment_kasan': "60単位/月",
        'day_service_koku_eiyo_screening_kasan': "20単位/回(I), 5単位/回(II)",
        'day_service_kansensho_saigai_riyo_gen_kasan': "基本報酬の3%",
        'day_service_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'day_service_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'day_service_nakasangan_tokubetsu_chiiki_kasan': "地域・規模により変動",
        'day_service_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'home_visit_shokai_kasan': "200単位/月",
        'home_visit_futari_homon_kasan': "所定単位数の100%",
        'home_visit_kinkyu_homon_kasan': "100単位/回",
        'home_visit_seikatsu_kino_kojo_renkei_kasan': "100単位/月",
        'home_visit_koku_renkei_kyoka_kasan': "50単位/回",
        'home_visit_socho_yakan_shinya_kasan': "25%増(早朝・夜間), 50%増(深夜)",
        'home_visit_tokutei_jigyosho_kasan': "体制により変動",
        'home_visit_ninchisho_senmon_care_kasan': "3単位/日(I), 4単位/日(II)",
        'home_visit_nakasangan_tokubetsu_chiiki_homon_kasan': "地域・規模により変動",
        'home_visit_tokubetsu_chiiki_homon_kasan': "15%増",
        'home_visit_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'home_visit_seisansei_kojo_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'home_nursing_kinkyu_homon_kango_kasan': "265単位/回(I), 540単位/回(II)",
        'home_nursing_yakan_socho_homon_kango_kasan': "2130単位/回",
        'home_nursing_shinya_homon_kango_kasan': "4260単位/回",
        'home_nursing_chojikan_homon_kango_kasan': "300単位/週",
        'home_nursing_fukusumei_homon_kango_kasan': "状況により変動",
        'home_nursing_tokubetsu_chiiki_homon_kango_kasan': "15%増",
        'home_nursing_nanbyo_fukusukai_homon_kasan': "状況により変動",
        'home_nursing_nyuyoji_kasan': "150単位/日",
        'home_nursing_tokubetsu_kanri_kasan': "250単位/月(I), 500単位/月(II)",
        'home_nursing_terminal_care_kasan': "2000単位/死亡月",
        'home_nursing_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'home_nursing_senmon_kanri_kasan': "250単位/月",
        'short_stay_shoki_kasan': "30単位/日",
        'short_stay_iryo_renkei_taisei_kasan': "状況により変動",
        'short_stay_mitori_renkei_taisei_kasan': "状況により変動",
        'short_stay_koku_renkei_kyoka_kasan': "50単位/回",
        'short_stay_nyuyoku_kaijo_kasan': "40単位/日",
        'short_stay_kobetsu_kino_kunren_kasan': "56単位/日",
        'short_stay_jakunen_ninchisho_ukeire_kasan': "120単位/日",
        'short_stay_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'short_stay_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'short_stay_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'group_home_shoki_kasan': "30単位/日",
        'group_home_mitori_kaigo_kasan': "看取りの段階により変動",
        'group_home_taikyo_ji_joho_teikyo_kasan': "500単位/回",
        'group_home_kyoryoku_iryo_kikan_renkei_kasan': "100単位/月",
        'group_home_ninchisho_team_care_suishin_kasan': "150単位/月",
        'group_home_eiyo_koku_kanri_kasan': "状況により変動",
        'group_home_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'group_home_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'group_home_koreisha_shisetsu_kansentaisaku_kojo_kasan': "状況により変動",
        'group_home_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'syotaki_shoki_kasan': "30単位/日",
        'syotaki_ninchisho_kasan': "状況により変動",
        'syotaki_yakkin_taisei_kasan': "配置状況により変動",
        'syotaki_mitori_renkei_taisei_kasan': "状況により変動",
        'syotaki_kinkyu_homon_kasan': "状況により変動",
        'syotaki_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'syotaki_nakasangan_tokubetsu_chiiki_kasan': "地域・規模により変動",
        'syotaki_kagakuteki_kaigo_suishin_kasan': "状況により変動",
        'syotaki_kaigo_shokuin_shogu_kaizen_kasan': "報酬総額に加算率を乗算",
        'home_rehab_rehab_management_kasan': "計画内容により変動",
        'home_rehab_tanki_shuchu_rehab_kasan': "200単位/日",
        'home_rehab_ninchisho_tanki_shuchu_rehab_kasan': "200単位/日",
        'home_rehab_iko_shien_kasan': "500単位/回",
        'home_rehab_taiin_kyodo_shido_kasan': "600単位/回",
        'home_rehab_service_teikyo_taisei_kyoka_kasan': "実績・体制により変動",
        'home_rehab_koku_renkei_kyoka_kasan': "50単位/回",
        'home_rehab_nakasangan_tokubetsu_chiiki_kasan': "地域・規模により変動",
        'home_rehab_tokubetsu_chiiki_homon_rehab_kasan': "15%増",
        'home_rehab_kagakuteki_kaigo_suishin_kasan': "報酬総額に加算率を乗算"
    };
